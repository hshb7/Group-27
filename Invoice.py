class Invoice:
    ...
    def itemQuantity(self, products):
        total_itemQuantity = 0
        for k, v in products.items():
             total_itemQuantity += (int(v['qnt']))
        total_itemQuantity = round(total_itemQuantity, 2)
        self.total_itemQuantity = total_itemQuantity
        return total_itemQuantity
